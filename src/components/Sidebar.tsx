const Sidebar = () => (
  <nav class="bg-sidebar text-white h-[calc(100vh-64px)] w-16 flex flex-col items-center">
    ...
    <button class="btn btn-ghost mt-3 btn-disabled" title="Copy link">
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <button class="btn btn-ghost mt-3 btn-disabled" title="Copy note">
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <button class="btn btn-ghost mt-3 btn-disabled" title="Duplicate and edit">
      <svg
        xmlns="http://www.w3.org/2000/svg"
